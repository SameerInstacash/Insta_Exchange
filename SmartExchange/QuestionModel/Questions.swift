...
public class Questions: NSCoding {
  ...
  private let kQuestionsConditionNameKey: String = "conditionName"
    //private let kQuestionsAppCodesKey: String = "appCodes"
  ...
  */
  public init(json: JSON) {
    ...
    conditionName = json[kQuestionsConditionNameKey].string
      ...
      //if let items = json[kQuestionsAppCodesKey].array { appCodes = items.map { [String].self(json: $0) } }
  }
  ...
  */
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = conditionName { dictionary[kQuestionsConditionNameKey] = value }
      ...
      //if let value = appCodes { dictionary[kQuestionsAppCodesKey] = value.map { $0.dictionaryRepresentation() } }
